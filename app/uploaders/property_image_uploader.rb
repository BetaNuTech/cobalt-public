class PropertyImageUploader < CarrierWave::Uploader::Base
  ...
  version :normal_3x do
    process resize_to_fill: [400, 300]
  end
  
  version :normal_2x, from_version: :normal_3x do
    process resize_to_fill: [267, 200]
  end

  version :normal, from_version: :normal_2x do
