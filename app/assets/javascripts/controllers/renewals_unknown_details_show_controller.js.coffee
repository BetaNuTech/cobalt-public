class Cobalt.RenewalsUnknownDetailsShowController
  
  initialize: () ->
    @getParams()
    property_id = @params["property_id"]
    date = @params["date"]
    @baseDataTableUrl = "/renewals_unknown_details.json?property_id=#{property_id}&date=#{date}"
  ...
  createDataTable: () ->
    ...
    @dataTable = $("#renewals_unknown_details_table").DataTable(options)
