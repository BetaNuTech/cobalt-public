class Cobalt.ComplianceIssuesShowController
  
  initialize: () ->
    @getParams()
    property_id = @params["property_id"]
    date = @params["date"]
    @baseDataTableUrl = "/compliance_issues.json?property_id=#{property_id}&date=#{date}"
  ...
  createDataTable: () ->
    ...
    @dataTable = $("#compliance_issues_table").DataTable(options)
